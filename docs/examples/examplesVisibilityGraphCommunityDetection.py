...
### plot weighted normal visibility graph, weight is  Euclidean distance
g_nx_NVG, A_NVG = visibilityGraphCommunityDetection.createVisibilityGraph(data,tp,"general", weight = 'distance')
filename = './B.eps'
